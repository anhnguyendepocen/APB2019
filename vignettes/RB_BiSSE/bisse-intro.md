...
for other types of traits [@FitzJohn2010, @Goldberg2011, @Goldberg2012, @MagnusonFord2012 @FitzJohn2012, @Beaulieu2016, @Freyman2018].

#Background: The BiSSE Model 

The binary state speciation and extinction model (BiSSE) [@Maddison2007
...
clade comparisons [@Mitter1988] can be thrown off if the transition
...
they can cause trouble [@Goldberg2008]. An alternative is to use the
...
and BiSSE parameters [@FitzJohn2009]. Perhaps better is to treat the
...
arbitrary number of states [@FitzJohn2012]. The only extra piece is
